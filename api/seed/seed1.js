...
const equipos = [
{
    ...
    cantMiembros: 7,
    activo: true,
    detalles: "Todos los fines de semanas recorremos el barrio Puertas Amarrillas de Rosario para evaluar la construcción de viviendas",
...
},
{
    ...
    cantMiembros: 5,
    activo: true,
    detalles: "Este equipo trabaja en el barrio La Ilusión de La Plata desarrollando un comedor infantil para más de 50 niñxs. Trabajamos con la comunidad desde 2014.",
...
},
{
    ...
    cantMiembros: 4,
    activo: true,
    detalles: "Nos encargamos de la organización y planificación de las construcciones que Techo lleva a cabo en el Gran Buenos Aires.",
...
},
{
    ...
    cantMiembros: 5,
    activo: true,
    detalles: "Somos un equipo que se encarga de brindar apoyo escolar para los niños y niñas de los barrios de Zárate en los que TECHO está presente.",
...
const personas = [
    ...
    },
    {
        ...
        intereses: "['Gestión Comunitaria', 'Administración y Finanzas', 'Vivienda y Habitat', 'Gestión de tiempo', 'Liderazgo','Gestión de Proyectos']"
    },
    {
        idPersona: 791723,
...
const personasActividades = [
    ...
    //password: 123456789
    "mariana.gutierrez@gmail.com", "franco.salazar@gmail.com", "johana.gonzalez@gmail.com", "joaquin.molina@gmail.com", "monica.suarez@gmail.com", "eber.fratini@gmail.com", "luciana.maurette@gmail.com", "juan.valdez@gmail.com",
    //Usuarios solo registrados en ACTIVIDADES, mismo password
    "viviana.gomez@gmail.com", "leandro.martinez@gmail.com"
]